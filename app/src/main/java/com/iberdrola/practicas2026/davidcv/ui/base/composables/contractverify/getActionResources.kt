...
import com.iberdrola.practicas2026.davidcv.ui.screens.contractactions.ContractActions.MODIFYSTATUS
...
fun getActionResources(action: ContractActions): Pair<Int, String> {
    val titleRes = when (action) {
        ...
        MODIFYSTATUS -> R.string.cvcTitleDesactivate
    ...
    val notifyText = stringResource(when (action) {
        ...
        MODIFYSTATUS -> R.string.cascTitleDesactivate
